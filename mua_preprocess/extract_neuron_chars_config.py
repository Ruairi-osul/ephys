...
ops = Options(recordings_to_extract=['2018-10-02'],
              experiment='DREADD',
              kilosort_folder=r'/media/ruairi/UBUNTU/SERT_DREADD/dat_files/cat',
              spikes_df_csv_out_folder=r'/media/ruairi/UBUNTU/SERT_DREADD/csvs',
              sampling_rate=30000,

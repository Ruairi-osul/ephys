...
ops.fbinary = '/media/ruairi/UBUNTU/CIT_WAY/dat_files/cat/2018-08-08/2018-08-08.dat' % will be created for 'openEphys';
ops.fproc = '/media/ruairi/UBUNTU/CIT_WAY/dat_files/cat/2018-08-08/temp_wh.dat' % residual from RAM of preprocessed data;
ops.root = '/media/ruairi/UBUNTU/CIT_WAY/dat_files/cat/2018-08-08' % 'openEphys' only: where raw files are;		
...
ops.nNeighPC            = 12; % visualization only (Phy): number of channnels to mhask the PCs, leave empty to skip (12)		
...
ops.chanMap             = '/home/ruairi/repos/TranKilosort/Cambridge32/chanMap.mat'; % make this file using createChannelMapFile.m		
